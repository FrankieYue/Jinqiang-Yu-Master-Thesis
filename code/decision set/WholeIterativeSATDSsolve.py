from util.WholeIterativeSATdssolver import WholeIterativeSATdsSolver
from util.WholeIterativeSATds import WholeIterativeSATds
...
def WholeIterativeSATDSSolve(filename, no_ins, N):
    print("File: {0}\n".format(filename))
    ...
    for ins in range(no_ins):
        ...
        found = False
        while not found:
            DDS_solver = WholeIterativeSATdsSolver(K, N, data)
